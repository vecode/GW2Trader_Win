...
{
    public class ItemDetailsFragmentAdapter2 : FragmentPagerAdapter
    {
        ...
        public ItemDetailsFragmentAdapter2(FragmentManager fm, Item item)
            : base(fm)
        {
            _item = item;
            _fragmentManager = fm;
        ...
        public override Fragment GetItem(int position)
        {
            ...
            //_fragmentTagReference[position] = fragment;
            return fragment;
        }
